...
import { CashewWarehouseTransactionRecord } from 'src/library/powersync/schemas/AppSchema'
...
export default function TransactionList({ transactions }: TransactionListProps) {
	...
	const groupedTransactions = transactions.reduce(
		...
		{} as Record<string, CashewWarehouseTransactionRecord[]>,
	)
	...
	return (
		<FlatList
			...
			renderItem={({ item }: { item: [string, CashewWarehouseTransactionRecord[]] }) => {
			...
			keyExtractor={(item: [string, CashewWarehouseTransactionRecord[]]) => item[0]}
			...
			ListEmptyComponent={() => <EmptyPlaceholder message="Nenhuma transacção encontrada" />}
