...
import { CoopAffiliationStatus, CoopPurpose } from 'src/types'
import { CoopFormDataType } from 'src/store/organizations'
...
export default function PreviewCoop({ org, adminPostName, villageName }: PreviewCoopProps) {
