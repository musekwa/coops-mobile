import { Text, View, useWindowDimensions, Modal, ScrollView, TouchableOpacity } from 'react-native'
import React, { useState, useEffect } from 'react'

import { z } from 'zod'
import { Controller, useForm, FieldErrors, UseFormResetField, UseFormWatch, Control } from 'react-hook-form'
import { zodResolver } from '@hookform/resolvers/zod'
import { AddressLevel, CoopAffiliationStatus, CoopPurpose, OrganizationTypes } from 'src/types'
import { getFullYears } from 'src/helpers/dates'
import CustomTextInput from '../custom-text-input/CustomTextInput'
import { CustomPicker } from '../custom-select-item/CustomPicker'
import { useAssociationStore } from 'src/store/organizations'
...
import CheckButton from 'src/components/buttons/CheckButton'
import SelectAddress from 'src/custom-ui/select-address'
import { useUserDetails } from 'src/hooks/queries'
import { useAddressStore } from 'src/store/address'
import { useCheckOrganizationDuplicate } from 'src/hooks/useCheckOrganizationDuplicate'
