...
export const categoriesCardDetails: CategoryCardType[] = [
	...
	{
		actorCategory: ActorCategory.EXPORTER,
		description: 'Exportadores.',
		title: 'Exportadores',
		bannerImage: exportCategoryImageUri,
		// icon: 'account',
	},
	{
		actorCategory: ActorCategory.GROUP,
		description: 'Cooperativas, Associações, Grupos e Uniões.',
		title: 'Grupos',
		bannerImage: actorOrganizationsImageUri,
		// icon: 'account',
	},
]
